        ...
        <div class="p-4 text-center md:text-left md:justify-items-start min-w-full min-h-full">
            ...
            <x-slot name="description">
                <div class="pl-4 pt-4 pb-4 text-gray-800 font-bold text-md">
                    {{ __('Ensure your account is using a password that is at least 8 characters long, not more than 100 characters, and has uppercase, numeric, and special characters.') }}
                </div>
            </x-slot>
        </div>
    </div>
